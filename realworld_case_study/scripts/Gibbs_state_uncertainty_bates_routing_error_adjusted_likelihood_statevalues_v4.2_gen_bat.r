batch.file.initial.lines<-c(
  ...
  "#SBATCH --mem=5000",
  "",
  "module load R/3.4.0" # "module load R/3.5.1" #"module load R/3.4.0"
)
...
if(Sys.info()["sysname"]=="Linux"){
  ...
  rscript_runner<-"/datasets/work/LW_TVD_MDBA_WORK/8_Working/7_Shaun/data_backup/kim079/model_optimisation_framework_v2/scripts/Gibbs_state_uncertainty_bates_routing_error_adjusted_likelihood_runner_statevalues_v4.2.r"
} else {
  ...
  rscript_runner<-"Y:/scripts/Gibbs_state_uncertainty_bates_routing_error_adjusted_likelihood_runner_statevalues_v4.2.r"
...
output_dir<-"output/state_uncertainty/AM/bates/adjusted_likelihood_statevalues_v4.2"
batch.write.dir<-"scripts/bates_statevalues_v4.2"
