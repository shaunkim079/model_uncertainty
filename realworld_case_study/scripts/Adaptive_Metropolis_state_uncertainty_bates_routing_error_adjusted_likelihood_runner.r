...
if(Sys.info()["sysname"]=="Linux"){
  ...
  rscript<-"/data/kim079/model_optimisation_framework_v2/scripts/Adaptive_Metropolis_state_uncertainty_bates_routing_error_adjusted_likelihood.r"
} else {
  wd<-"C:/Users/kim079/Documents/model_optimisation_framework"
  rscript<-"C:/Users/kim079/Documents/model_optimisation_framework/scripts/Adaptive_Metropolis_state_uncertainty_bates_routing_error_adjusted_likelihood.r"
}
...
output_dir<-"//lw-osm-03-cdc.it.csiro.au/OSM_CBR_LW_TVD_MDBA_work/8_Working/7_Shaun/state_uncertainty/AM/bates/adjusted_likelihood"
